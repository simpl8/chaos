# coding=utf-8
# @Time : 2021/2/27 14:00
# @Author : Guye
# @Email : guye@iyunbao.com
# @File : AesCrypt.py
...
class AES_Crypt(object):
    ...
    def get_sha1prng_key(key: str) -> bytes:
        ...
        """
        signature = hashlib.sha1(key.encode()).digest()  # 返回摘要，作为二进制数据字符串值
...
if __name__ == '__main__':
    ...
    encrypt_res = "VQvUssyEHjmbSpseiDhd9Q"
    ...
    print(_key)
    # print(str(_key, "utf-8"))
    AES_Cryptor = AES_Crypt(_key, padding=AES_Crypt.PADDING_PKCS7)

    real_encrypt_res = AES_Cryptor.ECB_encrypt_to_base64(content)
    id = real_encrypt_res.rstrip("==")
    print("encrypt res", real_encrypt_res)
    print(id)
    #print("decrypt content", AES_Cryptor.ECB_decrypt_from_base64("R9BI6NWmJhZYI6pJxs9h7g=="))
